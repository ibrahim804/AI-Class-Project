...
public class Adventure {
	...
	public void discoverPath(Coordinate curCoordinate, List <Coordinate> adjacentCoordinates) {		
		...
		if(curGivenRoom.getStench()==1) {
			...
			if(Board.wumpusDetected) agent.shoot();
		} else {
	...
	private void doResolution(Coordinate curCoordinate, List <Coordinate> adjacentCoordinates, Coordinate whichTo, char danger) {
