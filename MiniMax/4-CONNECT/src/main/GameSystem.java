...
public class GameSystem {
	...
	public GameSystem(Board board, Scanner inp, int maxDepth) {
		this.board=board;
		this.inp=inp;
	...
	public boolean gameIsResultedBy(char symbol) {
		...
		if(getWin(symbol)) {
			...
			if(symbol=='X') {
				...
				System.out.println("Oh no, Computer wins !!");
			}
